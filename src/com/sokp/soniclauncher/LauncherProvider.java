...
import com.sokp.soniclauncher.AutoInstallsLayout.LayoutParserCallback;
import com.sokp.soniclauncher.LauncherSettings.Favorites;
import com.sokp.soniclauncher.compat.UserHandleCompat;
import com.sokp.soniclauncher.compat.UserManagerCompat;
import com.sokp.soniclauncher.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static String getAttributeValue(XmlResourceParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/com.sokp.soniclauncher", attribute);
        if (value == null) {
